...
class Model(torch.nn.Module):
    ...
    def __init__(self, input_shape, outputs_count, residual_count = [0, 0, 0, 0]):
        ...
        for i in range(residual_count[0]):
