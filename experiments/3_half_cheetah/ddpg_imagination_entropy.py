...
import models.ddpg_imagination_entropy.src.model_reward     as ModelReward
...
agent = libs_agents.AgentDDPGImaginationEntropy(env, ModelCritic, ModelActor, ModelEnv, ModelReward, Config)
